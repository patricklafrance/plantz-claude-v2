...
describe("subagent-stop entry point", () => {
    ...
    it("should exit 0 for _adlc-architect when no revision file exists", () => {
        // On a clean repo with no .adlc/architect-revision.md, architect should pass
        // (no revision = plan approved, and no plan files to mutate)
    ...
    it("should run _adlc-coder full pipeline and return valid output", () => {
