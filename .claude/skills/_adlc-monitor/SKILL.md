...
3. Write a slice file to `.adlc/slices/` describing the issue.
4. Spawn `subagent_type: "_adlc-coder"` with the slice and `mode: draft`.
5. Commit and push the fix.
6. Edit the PR comment from step 2 — mark the issue as fixed and summarize what changed.
