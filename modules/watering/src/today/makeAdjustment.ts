...
export function makeAdjustmentRecommendation(overrides: Partial<AdjustmentRecommendation> = {}): AdjustmentRecommendation {
    return {
        ...
        suggestedInterval: 5,
        explanation:
            "Based on 12 watering events, your plant is being watered more frequently than the current schedule. The average interval is 4.8 days versus the configured 7 days.",
        confidence: "high",
