...
- Reference: `modules/watering/today/src/LandingPage.stories.tsx`.
...
Domain storybook: `@apps/watering-storybook` (`apps/watering-storybook/`).

Story globs in `.storybook/main.ts` must include every subfolder in this module. When adding a subfolder, add its glob: `../../../modules/watering/{subfolder}/src/**/*.stories.tsx`.
