...
import checkBlockNodeModulesRead from "../../../src/hooks/preflight/block-node-modules-read.js";
...
describe("block-node-modules-read", () => {
    ...
    it("should allow Glob patterns targeting .d.ts in node_modules", () => {
        expect(
            checkBlockNodeModulesRead("Glob", { pattern: "**/node_modules/.pnpm/@tanstack+react-query*/node_modules/@tanstack/react-query/**/*.d.ts" })
        ).toBeNull();
    });
